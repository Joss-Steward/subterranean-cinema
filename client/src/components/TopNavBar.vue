		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6">
			<div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
				...
				<PopoverGroup as="nav" class="hidden md:flex space-x-10">
					...
					<RouterLink class="text-base font-medium text-gray-500 hover:text-gray-900" to="/">Home</RouterLink>
					<RouterLink class="text-base font-medium text-gray-500 hover:text-gray-900" to="/video">Video</RouterLink>
								...
								<div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
									...
									<div class="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
										...
										<div class="mt-5 text-sm">
											<a href="#" class="font-medium text-indigo-600 hover:text-indigo-500"> View all posts
